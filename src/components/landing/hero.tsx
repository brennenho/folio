...
export function Hero() {
  return (
    <div className="flex h-[calc(100vh-250px)] w-full flex-col items-center justify-center gap-6 p-16 text-center">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm">Learn more + no obligations</p>
      </div>
    </div>
  );
}
