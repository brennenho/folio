  ...
  return (
    <div className="flex w-full justify-center bg-foreground py-16 text-background md:py-36">
      <div className="flex w-5/6 flex-col items-center md:w-3/4">
        <AnimationWrapper className="text-center text-2xl font-medium tracking-wide md:text-4xl">
          Unlock Professional-Level Investing
        </AnimationWrapper>

        <div className="flex w-full flex-col items-center gap-8 pt-16 md:flex-row">
