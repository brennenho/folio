...
export function Overview() {
  return (
    <AnimationWrapper className="flex w-full items-center justify-center">
      <div className="flex w-5/6 flex-col items-center justify-center gap-4 rounded-2xl bg-muted py-4 text-center md:w-3/4 md:text-[1.7vw]">
        <p className="px-4 text-muted-foreground opacity-50">
          Eliminate the confusion all while saving time.
        </p>
        <Separator className="opacity-60" />
        <div className="my-[2.5%] w-[63%] text-center tracking-[0.68px]">
          <p>
